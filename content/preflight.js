        ...
        if (topic == "em-action-requested") {
            ...
            if (this._uninstall) {
                ...
                if (typeof current_ppue != "undefined") {
                    ...
                    } else if (current_ppue.search("chrome://preflight/content/extensions/extension-random.js") != -1) {
                        branch.setCharPref("pluginProvidedUserExtensions", current_ppue.replace("chrome://preflight/content/extensions/extension-random.js", ""));
                    }
                }
                ...
                if (typeof current_ppf != "undefined") {
                    ...
                    for (var ppf = 0; ppf < split_ppf.length; ppf++) {
                        ...
                        } else if (split_ppf[ppf].search("chrome://preflight/content/formats/preflight-formatter.js") != -1) {
                            branch.setCharPref("pluginProvidedFormatters", current_ppf.replace(split_ppf[ppf], ""));
                    }
                }
            }
